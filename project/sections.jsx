...
const EXPERIENCE = [
{
  ...
  bullets: [
  <>Identified <b>$257,000</b> in forecast-to-actual spend variances by reconciling cost data against SAP S/4HANA, investigating each discrepancy with initiative owners to protect budget integrity.</>,
  <>Co-led FY26Q4 and FY27Q1 quarterly planning across a <b>17-team, 485-resource</b> portfolio — consolidating timelines, resource forecasts and budget into the approved prioritisation roadmap.</>]
...
},
{
  ...
  <>Supported a <b>$4M digital transformation</b> for a national telco — working with the Salesforce Lead and Global Transformation Officer on delivery and BD strategy.</>]
...
},
{
  ...
  bullets: [
  <>Produced <b>6 monthly intelligence reports</b> for executive leadership and the board — forecasting national haulage demand through macroeconomic scenario analysis and flagging state and national risks.</>,
  <>Tracked <b>3 major players across 4 national rail corridors</b> to map market share, identifying the highest- and lowest-performing corridors to guide medium-to-long-term expansion strategy.</>,
...
},
{
  ...
  <>Mapped customer personas and a journey through primary research, contributing to a <b>25% uplift</b> in customer-satisfaction scores.</>]
...
{ co: "BDO", role: "Cybersecurity Intern", year: "2022", desc: "Reviewed 200+ documents across four projects to confirm compliance with ISO 27001, SOC 2 Type II, and CPS 234." },
